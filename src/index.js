const { uiGroups, syntaxGroups, ansiGroups, versionControlGroups } = require('./palette')
...
" VERSION CONTROL
call s:highlight_helper("DiffAdd", "NONE", "${versionControlGroups.addedBg}")
call s:highlight_helper("DiffChange", "NONE", "${versionControlGroups.modifiedBg}")
call s:highlight_helper("DiffDelete", "${versionControlGroups.removed}", "")
call s:highlight_helper("DiffText", "NONE", "${versionControlGroups.diffTextBg}", "BOLD")
